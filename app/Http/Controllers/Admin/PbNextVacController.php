...
class PbNextVacController extends Controller
{
    ...
    {
    //    dd('policies');
        $PbNextVacs = DB::table('vac_create_next_yrs')->paginate(10);
                $trades = trade::get();
                $ranks = rank::get();
        return view('admin.PbNextVac', compact('PbNextVacs',  'trades', 'ranks'));
    }
    /**
    ...
    public function edit(Request $request, $id)
    {
        ...
        $sheetNo = $request->sheetNo;
       DB::table('vac_create_next_yrs')->where('id', $id)->update([
        'trade'=>$trade,
        'rank'=>$rank,
        'next_yr'=>$next_yr,
        'next_2yrs'=>$next_2yrs,
