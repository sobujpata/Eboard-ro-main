            ...
            <a class="navbar-brand" href="{{ url('/eb-home') }}">
                ...
                <table style="margin-top: -12px;margin-bottom: -12px;">
                    <tr>
                        ...
                        <td>
                            <h4 style="margin-bottom: 0px; font-weight: 900;">Bangladesh Air Force</h4>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <h6 style="font-weight: 800">Evaluation Board-{{ date('y') }}</h6>
                        </td>
                    </tr>
                </table>
            </a>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-info">
                            <li><a class="dropdown-item nav-link" href="{{ url('/eb-selection') }}">Selection List</a>
                            </li>
                    ...
                    <li class="nav-item dropdown" style="display:@if ($userName == 'eb') none @endif">
                        ...
                        <ul class="dropdown-menu bg-info">
                            <li><a class="dropdown-item nav-link" href="{{ url('/eb-add-new-person') }}">Add New
                                    Person</a></li>
                            <div class="dropdown-divider"></div>
                            <li><a class="dropdown-item nav-link" href="{{ url('/eb-person-upload-ecxel') }}">Add New
                                    Person By Upload Excel</a></li>
                            <div class="dropdown-divider"></div>
                            <li><a class="dropdown-item nav-link" href="{{ url('/eb-image') }}">Profile Image
                                    Upload</a></li>
                            <div class="dropdown-divider"></div>
                            <li><a class="dropdown-item nav-link" href="{{ url('/eb-Profile') }}">Profile Upload</a>
                            </li>
                            <div class="dropdown-divider"></div>
                            <li><a class="dropdown-item nav-link" href="{{ url('/eb-conduct-sheet') }}">Contduct Sheet
                                    Upload</a></li>
                            <div class="dropdown-divider"></div>
                            <li><a class="dropdown-item nav-link" href="{{ url('/eb-application') }}">Application and
                                    Wornig Ltr</a></li>
                            <div class="dropdown-divider"></div>
                            <li><a class="dropdown-item nav-link" href="{{ url('/eb-salient') }}">Salient Pts of Appl &
                                    Wornig Ltr</a></li>
                            <div class="dropdown-divider"></div>
                            <li><a class="dropdown-item nav-link" href="{{ url('/eb-bdno') }}">All EB BD No</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
