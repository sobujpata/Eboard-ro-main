                ...
                <div class="row">
                    <div class="col-md-9">
                        <h3 class="text-decoration-underline text-center"
                            style="font-weight: bold; vertical-align:middle; margin-top: 50px;">
                            @if ($type == 0)
            ...
            <div class="col-md-12">
                <div class="card p-0 m-0">
                    <div class="card-body p-0">
                        <table id="tableData" class="example1 table table-striped table-hover" width="100%"
                            cellspacing="0">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class="text-center"
                                        style="vertical-align:middle; writing-mode: vertical-rl; transform: rotate(180deg);">
                                        Avg Mk of<br>Career Courses</th>
                                    <th class="text-center"
                                        style="vertical-align:middle; writing-mode: vertical-rl; transform: rotate(180deg);">
                                        Punishment</th>
                                    <th class="text-center"
                                    ...
                                    <tr id="tr{{ $person->id }}"
                                        ...
                                        <td class="text-center">
                                            <a href="{{ asset('evaluation-board/indv_application/' . $person->bdno . '.pdf') }}"
                                                target='_blank' style='text-decoration:none' class="hover-container">
                                                <img src="{{ asset('evaluation-board/appl.gif') }}" alt=""
                                        ...
                                        <td class="text-center">
                                            <a style="height: 35px;" class="text-danger mt-2" data-bs-toggle="modal"
                                                ...
                                                <img src="{{ asset('evaluation-board/salient_pts.jpg') }}" alt=""
                                                    srcset="" style="width:40px">
                                            </a>
                                                    ...
                                                    <div class="modal-content" style="background-color: #06c5f0;">
                                                        <div class="modal-header">
                                                            <h3 class="modal-title" id="myModalLabel"
                                                                style="width:100%;">Salient Pts of Appl</h3>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button style="height: 35px;" type="button" class="btn btn-success mt-2"
                                                data-bs-toggle="modal" data-bs-target="#exampleModal{{ $person->id }}">
                                                <img style="width: 14px;" src='{{ asset('icon/edit.png') }}'>
                                            </button>
                                            <button
                                                style="height: 35px; display:@if ($userName == 'eb') none @endif"
                                                    ...
                                                    <div class="modal-content" style="background-color: #06c5f0;">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="container-fluid">
                                                                ...
                                                                @endphp
                                                                <form method="POST"
                                                                    action="{{ route('eb.update', $person->id) }}">
                                                                    @csrf
                                                                    <h4 style="text-align: left;">Remarks By RO/D Pers:
                                                                    </h4>
                                                                    ...
                                                                    <div class="form-group"
                                                                        ...
                                                                        <label class=""
                                                                            for="flexCheckDefault">OtherRemarks:
                                                                        </label>
                                                                    ...
                                                                    <hr>
                                                                    <h4 style="text-align: left;">Please Select Your
                                                                        Decision:
                                                                    </h4>
                                                                    <div class="form-check"
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            id="final" name="decision" value="true"
                                                                        ...
                                                                        <input style="height:15px; width:15px;"
                                                                            type="radio" class="form-check-input"
                                                                            id="no_decision" name="decision"
                                                                            value=""
                                                                            @if ($person->decision == '') {{ 'checked' }} @endif>
                                                                        <label class="form-check-label"
                                                                            for="no_decision">Clear
                                                                            Decision</label>
                                                                    </div>
                                            ...
                                            <div class="modal fade" id="persEdit{{ $person->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content" style="background-color: #06c5f0;">
                                                        <div class="modal-header">
                                                            <h3 class="modal-title" id="myModalLabel"
                                                                style="width:100%;">Update Person</h3>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="container-fluid">
                                                                ...
                                                                @endphp
                                                                <form method="POST"
                                                                    action="{{ route('eb.edit', $person->id) }}"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="form-group">
                                                                                <label for="conduct_sheet">Conduct
                                                                                    Sheet</label>
                                                                                <input type="text" name="conduct_sheet"
                                                                                    id="" class="form-control"
                                                                                    value="{{ $person->conduct_sheet }}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="type" id=""
                                                                                    ...
                                                                                    <option value="" disabled>Select
                                                                                        Type</option>
                                                                                    <option value="0"
                                                                                        @if ($person->type == 0) selected @endif>
                                                                                        Applied Pers</option>
                                                                                    <option value="1"
                                                                                        @if ($person->type == 1) selected @endif>
                                                                                        Screening Pers</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-3">
