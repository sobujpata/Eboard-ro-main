            ...
            <table class="table table-striped p-0">
                ...
                <tbody>
                    ...
                    {{-- @foreach ($results as $item) --}}
                        <tr
                            class= "{{ $item->decision == '1' ? 'tr-row-bg-select' : ($item->decision == '0' ? 'tr-row-bg-stanby' : 'inherit') }}">
                            <td align='center'>{{ $results->firstItem() + $key }}</td>
                            ...
                            <td align='center' style="vertical-align: middle; ">
                                ...
                                <form action="{{ route('PersList.delete', $item->id) }}" method="POST" style="display:inline;">
                                    @csrf @method('DELETE')
                                    <button onclick="return confirm('Delete this?')" class="btn btn-sm btn-danger mb-0">Delete</button>
                                </form>
                                {{-- <button type="button"
                                        class="btn btn-danger mt-2"
                                        style="height: 35px;"
                                        onclick="confirmDelete('{{ url('/admin/pb/PersList/delete/'.$item->id) }}')">
                                    Delete
                                </button> --}}
                                <!-- Person Edit Modal -->
                                        ...
                                        <div class="modal-content" style="background-color: #06c5f0;">
                                            ...
                                            <div class="modal-body">
                                                <div class="container-fluid">
                                                    ...
                                                    @endphp
                                                    <form method="POST"
                                                        action="{{ route('PbPersList.edit', $item->id) }}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="s_no">S/L</label>
                                                                    <input type="text" name="s_no" id=""
                                                                        class="form-control" value="{{ $item->s_no }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="bdno">BD No</label>
                                                                    <input type="text" name="bdno" id=""
                                                                        class="form-control" value="{{ $item->bdno }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="rank">Rank</label>
                                                                    <input type="text" name="rank" id=""
                                                                        class="form-control" value="{{ $item->rank }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="trade">Trade</label>
                                                                    <input type="text" name="trade" id=""
                                                                        class="form-control" value="{{ $item->trade }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="es">Entry Sr</label>
                                                                    <input type="text" name="es" id=""
                                                                        class="form-control" value="{{ $item->es }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="cs">Command Sr</label>
                                                                    <input type="text" name="cs" id=""
                                                                        class="form-control" value="{{ $item->cs }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="weight">Weight (Lbp)</label>
                                                                    <input type="text" name="weight" id=""
                                                                        class="form-control" value="{{ $item->weight }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
