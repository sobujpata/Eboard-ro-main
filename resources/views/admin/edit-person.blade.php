                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="trade" id="trade_update" class="form-control form-select">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ttl_score" id="ttl_score" class="form-control" value="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="base" id="base" class="form-control form-select">
                                        <option value="" disabled selected>Select Base</option>
                                        @foreach ($bases as $base)
                                            <option value="{{ $base->name }}">{{ $base->name }}
                                            </option>
                                        @endforeach
                                    </select>
...
@push('other_script')
    <script>
        async function FillUpUpdateForm(id, image){
            ...
            document.getElementById('trade_update').value =res.data.trade;
            ...
            document.getElementById('base').value =res.data.base;
