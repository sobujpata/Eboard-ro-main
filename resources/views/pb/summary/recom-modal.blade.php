...
<div class="modal fade" id="RecomList" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" style="background-color: #06c5f0;">
            ...
            <div class="modal-body" id="DataPrint">
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col-4 text-center">
                        <h3 class="modal-title text-decoration-underline" id="myModalLabel" style="width:100%;"><span
                                id="tradeHeader"></span> <span id="rankHeader"></span> Recom List</h3>
                    </div>
                    <div class="col-4"></div>
                </div>
...
@push('other_script')
    <script>
        function Print() {
            const printContents = document.getElementById('DataPrint').innerHTML;
    ...
    <script>
        async function FillUpDataTable(trade, rank) {
            ...
            let tbody = document.getElementById('RecomTbody');
