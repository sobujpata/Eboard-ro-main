                                ...
                                @foreach ($policies as $policy)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body" style="padding: 10px 30px 10px 30px;">
                                                            <form method="POST"
                                                                ...
                                                                <div class="form-group pb-3">
                                                                    <label class="form-lavel"
                                                                        style="float: left !important">Published
                                                                        Date</label>
                                            ...
                                            <a href="{{ Route('policy.delete', $policy->id) }}" class="btn btn-danger"
                                                style="display:@php if($user->userName !== 'pbedit'){ echo 'none;'; } @endphp">Delete</a>
